...
docker-up-tools: ## Start optional local development tools, including NUI, Redis Insight, Grafana, Loki, and Prometheus.
	docker compose --profile tools up -d nui redisinsight loki prometheus grafana alloy
