.PHONY: stress-tickets check-load-test-token validate-k6-tickets-list-profile validate-k6-tickets-create-profile prepare-k6-tickets-list k6-tickets-list seed-performance-tickets prepare-k6-tickets-create k6-tickets-create
